    ...
    public partial class Main : MaterialForm
    {
        ...
        public bool WriteDataTableToExcel(System.Data.DataTable dataTable, string worksheetName, string saveAsLocation, string ReporType)
        {
            ...
            try
            {
                ...
                FormattingExcelCells(excelCellrange, "#FF6347", System.Drawing.Color.Black, true);
        ...
        private void materialRaisedButton6_Click(object sender, EventArgs e)
        {
            ...
            WriteDataTableToExcel(dt, "Отчет по невыполненным задачам", reportPath + "\\ExpiredTasks-" + reportDate, "Отчет по невыполненным задачам");
        ...
        private void materialRaisedButton7_Click(object sender, EventArgs e)
        {
            ...
            WriteDataTableToExcel(dt, "Отчет по отложенным задачам", reportPath + "\\DelayedTasks-" + reportDate, "Отчет по отложенным задачам");
            MessageBox.Show("Отчет создан");
        }
